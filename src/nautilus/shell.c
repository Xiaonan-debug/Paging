...
//#ifdef NAUT_CONFIG_ASPACES
    ...
    // Only do 64 MB of comparisons, because 1 GB takes too long
    nk_vc_printf("Comparing two memory mapped regions\n");
    if (memcmp((void*)0x100000, (void*)(0xffff800000000000UL+0x100000), 0x4000000)) {
